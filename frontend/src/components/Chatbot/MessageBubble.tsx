...
export const MessageBubble: React.FC<MessageBubbleProps> = ({ message, onExampleClick, onEditClick }) => {
    ...
    >
      ...
      <div className={`flex flex-col max-w-[75%] ${isUser ? 'items-end' : 'items-start'}`}>
        ...
        >
          ...
          {isUser && onEditClick && (
            <button
              onClick={() => onEditClick(message.content)}
              className="absolute -left-8 top-1/2 -translate-y-1/2 opacity-0 group-hover:opacity-100 transition-opacity p-1.5 rounded-lg bg-[#1e1e28] hover:bg-[#252532] border border-white/10 text-zinc-500 hover:text-zinc-300"
